...
- **[grill-with-docs-hermes](./grill-with-docs-hermes/SKILL.md)**: Fork-local Hermes adaptation of grill-with-docs. Same round-based interview, but every resolved product/design answer lands in a named spec file (PRODUCT_SPEC, DESIGN_SPEC, MVP_SCOPE, BUILD_SLICES, RISK_REGISTER, KANBAN_TASKS) instead of staying in the conversation. User-invoked.
